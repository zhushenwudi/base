package com.zhushenwudi.base.mvvm.ext.util
...
import com.zhushenwudi.base.mvvm.base.appContext
import com.zhushenwudi.base.mvvm.ext.view.clickNoRepeat
...
fun toast(
    ...
    ToastUtils.showToast(context, resId, duration)
}