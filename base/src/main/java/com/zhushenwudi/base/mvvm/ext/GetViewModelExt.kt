package com.zhushenwudi.base.mvvm.ext

import androidx.appcompat.app.AppCompatActivity
import androidx.fragment.app.Fragment
import androidx.lifecycle.ViewModelProvider
import com.zhushenwudi.base.mvvm.base.BaseApp
import com.zhushenwudi.base.mvvm.base.viewmodel.BaseAppViewModel
 ...
 */
inline fun <reified VM : BaseAppViewModel> AppCompatActivity.getAppViewModel(): VM {
 ...
 */
inline fun <reified VM : BaseAppViewModel> Fragment.getAppViewModel(): VM {
...
inline fun <reified VM : BaseAppViewModel> AppCompatActivity.getViewModel(): VM {
 ...
 */
@Deprecated("已过时的方法，现在可以直接使用Ktx函数 viewmodels()获取")
inline fun <reified VM : BaseAppViewModel> Fragment.getViewModel(): VM {
    return ViewModelProvider(
        this,
...
inline fun <reified VM : BaseAppViewModel> Fragment.getActivityViewModel(): VM {
    return ViewModelProvider(
        requireActivity(),
        ViewModelProvider.AndroidViewModelFactory(this.requireActivity().application)
    ).get(VM::class.java)
